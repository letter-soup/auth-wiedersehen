	...
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.CreateTable(
			...
			table => new
			{
				...
				Description =
					table.Column<string>("character varying(1000)", maxLength: 1000, nullable: true),
		...
		migrationBuilder.CreateTable(
			...
			table => new
			{
				...
				ProtocolType =
					table.Column<string>("character varying(200)", maxLength: 200, nullable: false),
				...
				LastAccessed = table.Column<DateTime>("timestamp with time zone", nullable: true),
				NonEditable = table.Column<bool>("boolean", nullable: false),
				PushedAuthorizationLifetime = table.Column<int>("integer", nullable: true),
				RequirePushedAuthorization = table.Column<bool>("boolean", nullable: false),
			},
		...
		migrationBuilder.CreateTable(
			...
			table => new
			{
				...
				PostLogoutRedirectUri =
					table.Column<string>("character varying(400)", maxLength: 400, nullable: false),
				ClientId = table.Column<int>("integer", nullable: false),
			},
			constraints: table =>
			{
