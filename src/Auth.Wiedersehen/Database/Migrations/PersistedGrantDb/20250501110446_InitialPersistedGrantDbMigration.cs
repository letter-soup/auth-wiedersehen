	...
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		...
		migrationBuilder.CreateTable(
			...
			table => new
			{
				...
				Algorithm =
					table.Column<string>("character varying(100)", maxLength: 100, nullable: false),
		...
		migrationBuilder.CreateTable(
			...
			table => new
			{
				...
				ReferenceValueHash =
					table.Column<string>("character varying(64)", maxLength: 64, nullable: false),
				ExpiresAtUtc = table.Column<DateTime>("timestamp with time zone", nullable: false),
